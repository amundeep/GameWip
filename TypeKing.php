		...
		<div id="span6">
			<div class="title-game-comment text-center">
				...
				<div class="pure-control-group text-right">
					<textarea id="comment-box" rows="4" placeholder="Write some feedback..." style="width:600px;"></textarea>
				</div>	
				<button id="send-comment" class="pure-button pure-button-primary" style="font-size:80%;">Send Comment to Developer</button>
			</div>
		</div>
	</div>	
